...
export const TEAM_GEO = {
  ...
  "Miami Marlins": { lat: 25.7781, lng: -80.2197, city: "Miami" },
  "馬林魚": { lat: 25.7781, lng: -80.2197, city: "Miami" },
  "Minnesota Twins": { lat: 44.9817, lng: -93.2777, city: "Minneapolis" },
  "雙城": { lat: 44.9817, lng: -93.2777, city: "Minneapolis" },
  // 中譯後的隊名(build_players 會把 org 譯成中文;英文 key 保留當後備,
  // 例如尚無中譯的小聯盟球隊仍會以英文原名進入 players.json)
  "響尾蛇": { lat: 33.4455, lng: -112.0667, city: "Phoenix" },
  "運動家": { lat: 38.5800, lng: -121.5169, city: "West Sacramento" },
  "紅襪": { lat: 42.3467, lng: -71.0972, city: "Boston" },
  "紅人": { lat: 39.0975, lng: -84.5069, city: "Cincinnati" },
  "老虎": { lat: 42.339, lng: -83.0485, city: "Detroit" },
  "太空人": { lat: 29.757, lng: -95.3555, city: "Houston" },
  "道奇": { lat: 34.0739, lng: -118.24, city: "Los Angeles" },
  "釀酒人": { lat: 43.028, lng: -87.9712, city: "Milwaukee" },
  "洋基": { lat: 40.8296, lng: -73.9262, city: "New York" },
  "費城人": { lat: 39.9061, lng: -75.1665, city: "Philadelphia" },
  "海盜": { lat: 40.4469, lng: -80.0057, city: "Pittsburgh" },
  "教士": { lat: 32.7073, lng: -117.1566, city: "San Diego" },
  "水手": { lat: 47.5914, lng: -122.3325, city: "Seattle" },
  "紅雀": { lat: 38.6226, lng: -90.1928, city: "St. Louis" },
  // 旅日 NPB
